...
public class FacebookConnectAction extends BaseStrutsAction {
	...
	Log _log = LogFactoryUtil.getLog(FacebookConnectAction.class.getName());
	...
	public String execute(
		...
		if (Validator.isNotNull(token)) {
			User user = setFacebookCredentials(
				session, themeDisplay.getCompanyId(), token, serviceContext);
	...
	protected User addUser(
			HttpSession session, long companyId, JSONObject jsonObject, ServiceContext serviceContext)
		throws Exception {
	...
	protected User setFacebookCredentials(
			HttpSession session, long companyId, String token, ServiceContext serviceContext)
		throws Exception {
